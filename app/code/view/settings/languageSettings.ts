...
export class Settings extends AppObject {

    private static languages: Array<any>;

    // public static getInstance(father?: Component): Settings {
    //     if (!Settings.instance) {
    //         Settings.instance = new Settings(father);
    //     }
    ...
    public run() {
        ...
        for (let index = 0; index < Settings.languages.length; index++) {
            let language = Settings.languages[index];
